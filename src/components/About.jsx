...
const About = ({theme}) => {
    return <div className="dark:bg-dark dark:text-white duration-300 sm:min-h-[600px] sm:grid sm:place-items-center">
        <div className="container">
            ...
            <div>
                <h1 className="text-3xl sm:text-4xl font-bold font-serif mt-[24px] flex justify-center">Notre concept</h1>
                <div className="space-y-4 text-base">
                    ...
                    <p>
                        <strong><a href="/contacts">Prenez rendez-vous</a></strong> et offrez à votre véhicule un soin d’exception, naturel et respectueux.
                    </p>
                </div>
            </div>
            </div>
